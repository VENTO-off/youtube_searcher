...
function ohSnap(text, options) {
    var defaultOptions = {
        ...
        'container-id': 'notifications', // id of the alert container
    ...
    let $container = $('#' + options['container-id']),
        icon_markup = "",
        color_markup = "";
    ...
    // Generate the HTML
    let html = $('<div class="alert ' + color_markup + '">' + icon_markup + text + '</div>').fadeIn(options['fade-duration']);
